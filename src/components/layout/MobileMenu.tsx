  ...
  return (
    <>
      ...
      {mounted && open && createPortal(
        <div
          className={`fixed inset-0 z-[200] flex flex-col bg-teal-dark transition-opacity duration-200 motion-reduce:transition-none ${show ? 'opacity-100' : 'opacity-0'}`}
        >
          {/* Header */}
          ...
          {/* Scrollable content */}
          <div
            className={`flex-1 overflow-y-auto px-5 py-5 transition-transform duration-300 ease-out motion-reduce:transition-none ${show ? 'translate-y-0' : 'translate-y-2'}`}
          >
            {/* Services */}
            ...
            <div className="space-y-0.5 border-t border-white/[0.07] pt-4">
              {navLinks.map(l => (
                <Link
                  key={l.href}
                  href={l.href}
          ...
          <div className="shrink-0 border-t border-white/[0.07] bg-teal-dark/95 px-5 pt-4 pb-[calc(1.25rem+env(safe-area-inset-bottom))]">
            <div className="flex flex-col gap-2.5">
              <a
                ...
                onClick={closeMenu}
                className="flex items-center justify-center gap-2.5 rounded-2xl bg-coral-ink px-5 py-3.5 text-sm font-semibold text-white shadow-lg shadow-coral/20 transition-colors hover:bg-coral"
              >
              ...
              <a
                ...
                onClick={closeMenu}
                className="flex items-center justify-center gap-2.5 rounded-2xl border border-white/10 bg-white/[0.05] px-5 py-3.5 text-sm font-medium text-white/75 transition-colors hover:bg-white/[0.08]"
              >
