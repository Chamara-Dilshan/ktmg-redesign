...
export default function DoctorCard({ doctor }: { doctor: Doctor }) {
  ...
  return (
    ...
    >
      {/* Avatar area — clean, minimal */}
      <div className="relative flex h-40 items-end justify-between overflow-hidden bg-teal-tint px-6 pb-5 pt-6">
        ...
        {/* FAAP badge */}
        {isFAAP && (
          <span className="relative rounded-full bg-coral px-2.5 py-1 text-[9px] font-bold uppercase tracking-wide text-white">
            FAAP
          </span>
        )}
      </div>
